...
user_df[X.select_dtypes(include=['float64', 'int64']).columns] = user_df[X.select_dtypes(include=['float64', 'int64']).columns].astype(float)

# Make predictions
y_user_pred = xgb_model.predict(user_df)
